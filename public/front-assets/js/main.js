...
(function ($) {
    ...
    proQty.prepend('<span class="fa fa-angle-down dec qtybtn"></span>'); // Decrement
    proQty.append('<span class="fa fa-angle-up inc qtybtn"></span>'); // Increment
    ...
    proQty.on("click", ".qtybtn", function () {
        ...
        if ($button.hasClass("inc")) {
            var newVal = oldValue + 1; // Correct: Increase when clicking "inc"
        } else {
            newVal = oldValue > 0 ? oldValue - 1 : 0; // Prevent negative values
        }
