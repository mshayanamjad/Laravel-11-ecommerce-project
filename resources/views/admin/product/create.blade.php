...
<div class="container">
    <div class="page-inner">
        ...
        <form action="" method="post" id="productForm" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
                {{-- Product Col 1 --}}
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="gallery-container">
                                            <div class="m-0" id="preview" style="display: flex; gap: 10px; margin-top: 10px; position: absolute; left: 10px; top:10px; z-index: 999;"></div>
                                    ...
                                    <div class="tab-content mt-2 mb-3" id="pills-tabContent">
										<div class="tab-pane fade active show" id="pills-general" role="tabpanel" aria-labelledby="pills-general-tab">
                                            ...
                                            <div class="form-group col-md-12 p-2">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">$</span>
                                                    <input type="text" class="form-control" name="sale_price" id="sale_price" placeholder="Sale Price" aria-label="Amount (to the nearest dollar)">
                                                    <p class="error m-0"></p>
                                                </div>
                                            </div>
										</div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="form-group col-md-12 product-catelog">
                                                @foreach ($subCategories as $subCategory)
                                                    <div class="form-check p-0">
                                                        <input class="form-check-input" type="checkbox" name="sub_category[]" id="{{ $subCategory->slug }}">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="form-group col-md-12 product-catelog">
                                                @foreach ($brands as $brand)
                                                    <div class="form-check p-0">
                                                        <input class="form-check-input" type="checkbox" name="brands[]" id="{{ $brand->slug }}" value="{{ $brand->id }}">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="form-group">
                                            <div class="input-group">
                                              <textarea class="form-control" name="short_desc" id="short_desc" style="height: 200px !important;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
