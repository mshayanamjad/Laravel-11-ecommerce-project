                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="card-title" style="white-space: nowrap;">Category List</div>
                        ...
                        <div class="card-body pt-0">
                            <ul class="nav nav-tabs nav-line nav-color-secondary" id="line-tab" role="tablist">
                                ...
                                <a
                                    ...
                                    id="line-profile-tab"
                                    href="{{ route('sub-category.active') }}"
                                ...
                                <a
                                    class="nav-link"
                                    id="line-contact-tab"
                                    href="{{ route('sub-category.block') }}"
                                    >Block({{ $blockCount }})</a
                                >
                                </li>
                            </ul>
                            <div class="tab-content mt-3 mb-3" id="line-tabContent">
                                <div class="tab-pane fade active show" id="line-profile" role="tabpanel" aria-labelledby="line-profile-tab">
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @if ($subCategories->where('status', 'active')->isNotEmpty())
                                                    @foreach ($subCategories->where('status', 'active') as $subCategory)                                                   
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-button-action">
                                                                    ...
                                                                    <form action="{{ route('sub-category.destroy', $subCategory->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                                                        @csrf
                                                                        @method('DELETE')
