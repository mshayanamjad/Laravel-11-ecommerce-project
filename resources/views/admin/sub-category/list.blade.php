                        ...
                        <div class="card-body pt-0">
                            <ul class="nav nav-tabs nav-line nav-color-secondary" id="line-tab" role="tablist">
                                ...
                                <a
                                    ...
                                    >All({{ $subCategories->count() }})</a
                                >
                                </li>
                                <li class="nav-item submenu">
                                <a class="nav-link" href="{{ route('sub-category.active') }}">
                                    Active({{ $subCategories->where('status', 'active')->count() }})
                                </a>
                                </li>
                                <li class="nav-item submenu" role="presentation">
                                <a
                                    ...
                                    >Block({{ $subCategories->where('status', 'block')->count() }})</a
                                >
                                </li>
                            </ul>
